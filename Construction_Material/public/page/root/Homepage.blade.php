        ...
        <div class="container">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine2.webp" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine3.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/paint1.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/paint2.webp" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine4.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine5.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine6.webp" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine10.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine8.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine7.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="shadow p-3 bg-body rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="image">
                                                    <a href="#"><img src="../image/machine9.jfif" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
         ...
         <div class="add-business bg-danger">
            <div class="btn d-flex flex-column p-4">
                ...
                <div class="p-1 fs-6"><p>Be our partner business and increase your online sales service more customers</p></div>
