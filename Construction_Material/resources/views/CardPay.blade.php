...
<head>
    ...
    <link rel="stylesheet" href="{{asset("css/CardPay.css")}}">
    <title>cardpay</title>
</head>
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-9 shadow p-3 bg-body rounded">
                <div class="no_selection">
                    <h5 style="text-align: center;">Welcome to Card Pay!</h5>
                    <form action="">
                        <h6><i class="fa fa-credit-card" style="font-size:20px"></i> Please provide credit card information</h6>
                        <input type="number" name="" id="num_card" placeholder="Credit Card Number">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" name="" id="" placeholder="CVV Card">
                            </div>
                        </div>
                    </form>
