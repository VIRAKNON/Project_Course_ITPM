            ...
            <tbody>
               <tr>
                  ...
                  <td class="d-flex">
                     {{-- action edit  --}}
                     <div>
                        <button type="button"  style="color:#C8CAD8"  class="btn px-2 m-0 border-0 shadow-none" data-bs-toggle="modal" data-bs-target="#edituser">
                           ...
                           <div class="modal-dialog modal-xl">
                                 <div class="modal-content">
                                    <div class="modal-header">
                                       <h5 class="modal-title fs-3 text-warning" id="exampleModalLabel">Edit User</h5>
